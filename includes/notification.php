...
<!DOCTYPE html> 
 <html>
	<head>
		<title>Notifications - Electic</title>
		  <meta charset="UTF-8" />
	...
	<div class="nav">
		...
		<div class="nav-left">
			<ul>
				...
				<li><a href="<?php echo BASE_URL;?>i/notifications"><i class="fa fa-bell" aria-hidden="true"></i>Notifications<span id="notificaiton"></a></li>
				<li><a href="<?php echo BASE_URL;?>i/notifications"><i class="fa fa-bell" aria-hidden="true"></i>Messages<span id="notificaiton"></a></li>
		...
		<?php if($data->type == 'retweet') :?>
			...
			<div class="notification-wrapper">
				<div class="notification-inner">
					...
					<div class="notification-tweet"> 
						<a href="<?php echo BASE_URL.$data->username;?>" class="notifi-name"><?php echo $data->screenname;?></a><span> retweet your <?php if($data->postBy === $user_id){echo 'Tweet';}else{echo 'Retweet';}?> - <span><?php echo $getFromU->timeAgo($data->time);?></span>
					</div>
					<div class="notification-footer">
						<div class="noti-footer-inner">

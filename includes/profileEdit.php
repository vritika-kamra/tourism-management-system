	...
	<?php
	   $tweets = $getFromT->getUserTweets($user_id); 
		 ...
		 foreach ($tweets as $tweet) {
			...
			$user         = $getFromT->userData($tweet->repostBy);
   			...
   			echo '<div class="all-tweet">
					<div class="t-show-wrap">	
					 <div class="t-show-inner">
						...
						' ; ' 
							<div class="t-show-popup" data-tweet="'.$tweet->postId.'" data-user="'.$tweet->postBy.'">
							 ...
							 ((!empty($tweet->image)) ?  
						       '<div class="t-show-body">
									  <div class="t-s-b-inner">
										   <div class="t-s-b-inner-in">
										     <img src="'.$tweet->image.'" class="imagePopup" data-tweet="'.$tweet->postId.'" data-user="'.$tweet->postBy.'"/>
										   </div>
									  </div>	
								   </div>' : '' ) .'
						...
						<div class="t-show-footer">
							<div class="t-s-f-right">
								<ul> 
									...
									<li>'.(($likes['likeOn'] ?? $tweet->postId) ? 
										'<button class="unlike-btn" data-tweet="'.$tweet->postId.'" data-user="'.$tweet->postBy.'"><i class="fa fa-heart" aria-hidden="true"></i><span class="likesCounter">'.(($tweet->likesCount > 0) ? $tweet->likesCount : '' ).'</span></button>' : 
										'<button class="like-btn" data-tweet="'.$tweet->postId.'" data-user="'.$tweet->postBy.'"><i class="fa fa-heart-o" aria-hidden="true"></i><span class="likesCounter">'.(($tweet->likesCount > 0) ? $tweet->likesCount : '').'</span></button>').'
									</li>
